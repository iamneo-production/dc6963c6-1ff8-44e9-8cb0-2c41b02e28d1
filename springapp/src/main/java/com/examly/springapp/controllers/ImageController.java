...
public class ImageController {
	...
	public  ResponseEntity<byte[]> getAllImage(@RequestHeader("imageId")String imageId){
		  byte[] image = null;
	...
	public  List<user> searchUser(@RequestHeader("user")String user){
		
		return userService.getSearchedList(user);
	}
	
	@RequestMapping(method=RequestMethod.GET,value="/getUser/{user}")
	public  userDetails getUserDetails(@PathVariable String user){
